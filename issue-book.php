                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">view</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Books</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Library Management System</h5>
                                            <p class="m-b-0">College of Engineering,Trivandrum</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Add New Books</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Book Id or Book Title</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control"
                                                                    placeholder="Enter book id or book title">
                                                                        ...
                                                                        <div class="row m-t-30">
                                                                            <div class="col-md-12">
                                                                                <button type="button" class="btn btn-primary btn-md btn-block  waves-effect waves-light text-center m-b-20">Issue</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
