                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Book Availability Status</h5>
                                                    </div>
                                                    <div class="card-block">
                                                        <form>
                                                            ...
                                                            <div class="col-sm-10">
                                                                    ...
                                                                    <input type="radio" id="html" name="#" value="html">
                                                                    <label for="html">Unavailable</label>
                                                                        ...
                                                                        <div class="row m-t-30">
                                                                            <div class="col-md-12">
                                                                                <button type="button" class="btn btn-primary btn-md btn-block  waves-effect waves-light text-center m-b-20">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
