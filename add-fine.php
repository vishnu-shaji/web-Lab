                                                    ...
                                                    <div class="card-block">
                                                        <form>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Enter Student id</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" placeholder="Enter student id ">
                                                                        ...
                                                                        <div class="row m-t-30">
                                                                            <div class="col-md-12">
                                                                                <button type="button" class="btn btn-primary btn-md btn-block  waves-effect waves-light text-center m-b-20">Paid</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
